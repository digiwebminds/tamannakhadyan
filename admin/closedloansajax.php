...
if(isset($_GET["searchvalue"]) && isset($_GET["searchby"])){
	...
	$sql = "SELECT * FROM loans WHERE status = 0 AND delete_status = 0 AND $searchby LIKE '$searchvalue' ORDER BY id DESC";
...
$sql = "SELECT * from loans WHERE status = 0 AND delete_status = 0 ORDER BY id DESC";
}

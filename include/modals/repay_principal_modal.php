...
<form action="queries.php" method="POST">
              <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 p-4">
                  ...
                  <div>
                      ...
                      <input type="number" name="loan_id" id="loan_id" value="' . $loanid . '" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required readonly>
                  </div>
                  <div>
                  ...
                  <div>
                      ...
                      <input type="number" name="principleAmountRepay" id="principle-amount-repay" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                  </div>
                  <div>
                  ...
                  <button type="submit" id="repay-principle-submitbtnn" name="repayPrincipalSubmit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                Pay Principle
                  </button>
              </div>
          </form>

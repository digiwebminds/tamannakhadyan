...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2023 at 03:09 AM
...
CREATE TABLE `loans` (
  ...
  `delete_status` int(10) NOT NULL DEFAULT 0 COMMENT '0=not deleted,1=deleted'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `principle_repayment` (
  ...
  `info` int(10) DEFAULT NULL COMMENT '0 = repay, 1=lend'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(4, 'asda', 'asdasd', 'asdad', 'asdas', '', 'adsa', 'asdas', 'asda', 1);
